...
function MypurchaseNothingToBill() {
          ...
          {dataItem.status !== 7 && dataItem.status !== 8 && (
            <>
              <Tooltip title="Check PO">
                ...
                >
                  <i class="fas fa-file-pdf d-flex"></i>
                </Link>
              </Tooltip>
                      ...
                      {isExpanded && (
                        <tr>
                          <td colSpan={columns.length}>
                            <div className="">
                              <Table responsive className=" table-striped table-bordered primary-table-head">
                                <thead>
                                  <tr>
                                    <th>Product Name</th>
                                    <th>Received</th>
...
export default MypurchaseNothingToBill;
