  ...
  const CustomCell = (props) => {
    ...
    return (
      <td>
        ...
        <label className="badge badge-outline-accent"><i className="fas fa-circle f-s-8 d-flex me-1"></i>Sales Order</label>
...
export default PurchaseSalesOrder;
