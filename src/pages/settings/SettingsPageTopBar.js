    ...
    <>
      <div className="gthh-controller-bar">
        <ul className="gth-controller-view-block">
          <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/company-info"
              ? "active" : ""
              } `} to="/company-info">
          ...
          {/* <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/whatsapp-setting"
          ...
          {/* <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/notification-setting"
          ...
          {/* <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/office-timing"
          ...
          <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/modules"
          ...
          <li>
            <Link className={`gth-controller-view-item ${location.pathname === "/permission"
          ...
          <li>
            <Link className={`gth-controller-view-item 
              ...
              ? "active" : ""
              } `} to="/settings/inventory/stores"><svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width={14}
                height={14}
                fill="currentColor"
                className='me-1'>
