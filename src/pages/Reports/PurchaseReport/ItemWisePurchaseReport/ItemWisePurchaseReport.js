...
function ItemWisePurchaseReport() {
  ...
  const fetchReportData = useCallback(async (startDate, endDate, page = 1, limit = 10, productId = null) => {
    try {
      setLoading(true);
      ...
      const response = await PrivateAxios.get('report/item-wise-purchase-report', { params });
      ...
      console.error('Error fetching item-wise purchase report:', error);
      setReportData([]);
    ...
    <div className="p-4">
      ...
      <div className="card mt-4">
        <div className="card-header bg-primary">
          <h4 className="card-title mb-0">Item-wise Purchase Report</h4>
        </div>
            ...
            <>
              <Grid data={reportData}>
                ...
                <GridColumn
                  ...
                  width="140px"
                  cell={(props) => (
                    <td className="text-end">₹ {(props.dataItem.total_amount_without_tax ?? 0).toLocaleString('en-IN')}</td>
                  )}
                />
                <GridColumn
                  ...
                  width="120px"
                  cell={(props) => (
                    <td className="text-end">₹ {(props.dataItem.total_tax_amount ?? 0).toLocaleString('en-IN')}</td>
                  )}
                />
                <GridColumn
                  ...
                  width="140px"
                  cell={(props) => (
                    <td className="text-end">₹ {(props.dataItem.total_received_amount ?? 0).toLocaleString('en-IN')}</td>
                  )}
                />
                <GridColumn
