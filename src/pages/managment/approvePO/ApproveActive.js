...
function ApproveActive() {
  ...
  const statuses = [
    { text: "All", value: null },
    { text: "Final Approval Pending", value: "Final Approval Pending" },
    { text: "Active", value: "Active" },
    { text: "Request For Quotation", value: "Request For Quotation" },
    { text: "Send to management", value: "Send to management" },
    { text: "Sales Order", value: "Sales Order" },
    { text: "Rejected from Admin", value: "Rejected from Admin" },
    { text: "Fully Billed", value: "Fully Billed" },
    { text: "Done", value: "Done" },
    { text: "Nothing to Bill", value: "Nothing to Bill" },
    { text: "Items Received Done", value: "Items Received Done" },
  ];
  ...
  const CustomCell = (props) => {
    ...
    return (
      <td>
        <label className="badge badge-outline-active"><i className="fas fa-circle f-s-8 d-flex me-1"></i>Active</label>
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <Modal.Body>
          <div className="">
            <Table responsive className="table-bordered price-compare-table">
              <thead>
                <tr>
                  <th>Vendor</th>
                  <th>Reference</th>
